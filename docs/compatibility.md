...
| <span style="white-space: nowrap;">Mangmi Air X</span>           | <span style="white-space: nowrap;">Android 14</span> | <span style="white-space: nowrap;">⚠️ Needs retest</span> | User tested before the recent alpha builds; Stock, GammaOS_Next_v1.2, may still work but needs retest                        |
| <span style="white-space: nowrap;">Anbernic RG477M</span>        | <span style="white-space: nowrap;">Android 14</span> | <span style="white-space: nowrap;">❌ Not working</span>   | User tested; [Cannot grant folder access to RetroArch config folder](https://github.com/misantronic/RAOfflineProxy/issues/4) |
