...
RAOfflineProxy currently supports **RetroArch, Dolphin, PPSSPP, ARMSX2, and WatermelonDS on Android**.
...
For that reason, emulators beyond RetroArch, Dolphin, PPSSPP, ARMSX2, and WatermelonDS are currently **not supported**, even if they also expose RetroAchievements features.
