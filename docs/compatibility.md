...
| ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <span style="white-space: nowrap;">AYN Thor</span>                                                                  | <span style="white-space: nowrap;">Android 13</span> | <span style="white-space: nowrap;">✅ Working</span> | Dev tested                                                                                                                                                 |
...
RAOfflineProxy currently supports **RetroArch, Dolphin, PPSSPP, ARMSX2, WatermelonDS, and Flycast on Android**.
...
For that reason, emulators beyond RetroArch, Dolphin, PPSSPP, ARMSX2, WatermelonDS, and Flycast are currently **not supported**, even if they also expose RetroAchievements features.
