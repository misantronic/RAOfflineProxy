...
RAOfflineProxy currently supports **RetroArch, Dolphin, and PPSSPP on Android**.
...
For that reason, emulators beyond RetroArch, Dolphin, and PPSSPP are currently **not supported**, even if they also expose RetroAchievements features.
