...
> You are installing the current alpha build: `v1.0.1-alpha4`.
...
Download `RAOfflineProxy-Knulli-v1.0.1-alpha4-Install.sh` from [GitHub Releases](https://github.com/misantronic/RAOfflineProxy/releases).
