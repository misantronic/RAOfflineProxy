...
> Current release stage: alpha (`v1.1.0-alpha4`). This is a public prerelease and has not gone through formal QA.

## What is RAOfflineProxy?

RAOfflineProxy is a local proxy that acts between supported emulators and [RetroAchievements](https://retroachievements.org/) (RA). It currently supports RetroArch and Dolphin on **Android**, and **KNULLI** and **Onion** (experimental) for Linux.
