...
RAOfflineProxy is a local proxy that acts between supported emulators and [RetroAchievements](https://retroachievements.org/) (RA). It currently supports RetroArch, Dolphin, PPSSPP, and ARMSX2 on **Android**, and **KNULLI**, **Onion**, **muOS**, and **ROCKNIX** (all alpha) for Linux.
