...
RAOfflineProxy is a local proxy that acts between supported emulators and [RetroAchievements](https://retroachievements.org/) (RA). It currently supports RetroArch, Dolphin, PPSSPP, ARMSX2, and WatermelonDS on **Android**, and **KNULLI**, **Onion**, **muOS**, and **ROCKNIX** for Linux.
