...
ASSET_NAME="${1:-cpython-3.11.10+20241016-x86_64-unknown-linux-gnu-install_only_stripped.tar.gz}"
...
echo "Run ./linux/retrodeck/build_bundle.sh to include it in the RetroDECK component bundle."
