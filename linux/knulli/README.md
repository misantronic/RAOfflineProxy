...
- `linux/knulli/dist/RAOfflineProxy-Knulli-v1.3.0-alpha1-Install.sh`
...
```bash
cp "path/to/RAOfflineProxy/linux/knulli/dist/RAOfflineProxy-Knulli-v1.3.0-alpha1-Install.sh" /path/to/mounted/knulli/share/roms/tools/
```
