...
> **Current release stage: `v1.4.0-alpha1`.** This is a public prerelease and has not gone through formal QA.
...
- **Android**: RetroArch, Dolphin, PPSSPP
- **Linux**: KNULLI, Onion

## Current Releases

- **Android**: [`v1.4.0-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.4.0-alpha1)
- **Linux**: [`v1.4.0-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.4.0-alpha1)
