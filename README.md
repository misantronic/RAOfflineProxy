...
> **Current release stage: `v1.5.4-alpha1`.** This is a public prerelease and has not gone through formal QA.
...
- **Android**: RetroArch, Dolphin, PPSSPP, ARMSX2
- **Linux**: KNULLI, Onion, muOS

## Current Releases

- **Android**: [`v1.5.4-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.5.4-alpha1)
- **Linux**: [`v1.5.4-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.5.4-alpha1)
