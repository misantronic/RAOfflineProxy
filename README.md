...
> **Current release stage: `v1.11.1-alpha1`.** This is a public prerelease and has not gone through formal QA.
...
- **Android**: RetroArch, Dolphin, PPSSPP, ARMSX2, WatermelonDS
- **Linux**: KNULLI, Onion, muOS, ROCKNIX, spruce (experimental)

## Current Releases

- **Android**: [`v1.11.1-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.11.1-alpha1)
- **Linux**: [`v1.11.1-alpha1`](https://github.com/misantronic/RAOfflineProxy/releases/tag/v1.11.1-alpha1)
...
- [Documentation Home](https://raofflineproxy.com)
- [Introduction](https://raofflineproxy.com/introduction.html)
- [Platforms](https://raofflineproxy.com/platforms.html)
- [Android Setup](https://raofflineproxy.com/installation.html)
- [Linux Support](https://raofflineproxy.com/linux-support/)
